%Calculation of operational costs for
%growth-phase of two-stage simulations

%The following algorithm is used to calculate the costs with aeration, agitation and 
%cooling for the growth phase of the two-stage production simulations, under aerobic 
%conditions. In order to use this algorithm, first run the desired DFBA simulation 
%in MATLAB. With that, run this algorithm and the aeration, agitation and cooling 
