%Calculation of operational costs for anaerobic one-stage and 
%for growth phase of two-stage simulations 
...
%each simulation that explores the trade-off between biomass and product formation 
%on the one-stage production simulations, or the growth phase of the two-stage 
%production simulations, under anaerobic conditions. To use this algorithm, 
...
% Volume of medium in the bioreactor:                                                                        volume = 200000; % L
...
t_OP = t((find((round(diff(concentration_X),4)<0.0001), 1)));                                                                
EStotal = 136.1*t_OP;
