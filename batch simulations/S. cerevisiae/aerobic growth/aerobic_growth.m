...
%aerobic conditions. In order to use this algorithm, first run the desired DFBA simulation 
%in MATLAB. With that, run this algorithm and the aeration, agitation and 
%cooling costs will be calculated.
