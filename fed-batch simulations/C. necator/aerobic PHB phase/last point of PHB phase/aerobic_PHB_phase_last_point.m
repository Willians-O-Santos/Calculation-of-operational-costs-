...
VO2_max = 5; %maximum ocygen uptake for C. necator

% time as calculated with the excel formula in the last point of PHB phase 
%from fed-batch simulations excel file
t_PHB_phase = 758.38; % time as calculated with the excel formula in the last point of PHB phase from fed-batch simulations excel file
