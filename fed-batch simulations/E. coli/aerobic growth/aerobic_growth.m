%Calculation of operational costs for aerobic one-stage and for
%growth-phase of two-stage simulations

%The following algorithm is used to calculate the costs with aeration, agitation and 
%cooling for each simulation that explores the trade-off between biomass and product 
%formation on the one-stage production simulations, or the growth phase of the two-stage 
%production simulations, under aerobic conditions. In order to use this algorithm, 
